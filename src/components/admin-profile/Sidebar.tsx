import SidebarItem from "../profile/SidebarItem";
  ...
  return (
    <div className="w-[280px] bg-white rounded-2xl p-4">
      <SidebarItem
        ...
        personal={true}
        icon={<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg "className="ml-3">
...
<path d="M20.59 22C20.59 18.13 16.74 15 12 15C7.26003 15 3.41003 18.13 3.41003 22" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
</svg>
      ...
      <SidebarItem
        ...
        icon={<svg width="24" height="24"  viewBox="0 0 24 24" fill="#3447AA" xmlns="http://www.w3.org/2000/svg" className="ml-3">
