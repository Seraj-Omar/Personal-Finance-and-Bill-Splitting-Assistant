...
const CARD_BASE =
  "flex flex-1 min-w-[250px] max-w-[320px] h-[99px] bg-white rounded-[16px] p-[16px]";
...
export default function FinancialOverview() {
  ...
  return (
    <div className="mt-[-40px] pt-[60px] flex justify-center w-full min-h-[252px] bg-[#f6f6f7b3] rounded-[16px] p-4">
        ...
        <div className="flex flex-wrap gap-4 mt-4 justify-center sm:justify-start">
          <div className={CARD_BASE}>
            <div className={`${ICON_BASE} bg-[rgba(22,97,224,0.13)]`}>
              ...
              >
                <g clip-path="url(#clip0_1744_1406)">
                  <path
            ...
            <div className="ml-3 flex flex-col">
              ...
              <div className="flex text-xs text-[rgba(255,80,80,1)] gap-2">
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <g clip-path="url(#clip0_1744_1430)">
                    <path
            ...
            <div className="ml-3 flex flex-col ">
              ...
              <div className="flex text-xs text-[rgba(72,185,113,1)] gap-2">
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <g clip-path="url(#clip0_1744_1447)">
                    <path
