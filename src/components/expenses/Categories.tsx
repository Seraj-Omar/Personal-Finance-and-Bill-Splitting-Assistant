...
const iconClass = "w-[21px] h-[19.5px]";
...
export default function Categories() {
  ...
  return (
    <section className="pt-10 px-6 pb-6">
      <div className="mb-6 flex items-center justify-between">
        <h2 className="text-[25px] leading-none text-[#1F1F1F]">
          Categories
        </h2>

        <button
          onClick={() => setOpen(true)}
          className="rounded-xl px-4 py-2 text-sm font-medium text-white transition main-bg-color hover:opacity-90"
        >
          Add new Expenses
        </button>
      </div>
  ...
  <div className="w-full xl:w-[72%] space-y-5">
    {isLoading && (
      <div className="rounded-2xl border border-[#E5E7EB] bg-white p-6 text-sm text-gray-500">
        Loading categories...
      </div>
    )}

    {isError && (
      <div className="rounded-2xl border border-[#F3D1D1] bg-white p-6 text-sm text-red-500">
  ...
  <div className="w-full xl:w-[28%] rounded-2xl bg-[#F9F9FA] p-4">
    <ExpensesDonutCard />
  </div>
</div>
